...
- Форма регистрации (имя, email, телефон) (для примера)
- Сохранение данных в базу (локальную - в качестве примера всё в одном репозитории)
- Простой и адаптивный дизайн (в рамках моих возможностей)
...
1. Клонируйте репозиторий:
   ...
   ```
2. Убедитесь, что у вас установлена актуальная версия [Python](https://www.python.org/)
3. Запустите `requirements.bat` для скачивания недостающих библиотек
4. Запустите `start.bat` (иногда streamlit предлагает указать почту для рекламы, можно просто пропустить, нажав Enter)
